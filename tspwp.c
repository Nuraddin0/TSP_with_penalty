...
int tour[MAX_NODES];
Edge **candidate; // Changed to dynamically allocated 2D array
...
int main() {
    ...
    // Allocate candidate array after K_NEAREST is known
    ...
    printf("Matrix size: %lld, K value: %d\n", matrix_size, K_NEAREST);
    ...
    printf("Time spent: %.2f seconds, %.2f\n", time_spent, time_spent / 60);
    return 0;
}
